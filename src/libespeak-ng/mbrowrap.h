 ...
 */
int read_MBR(short *buffer, int nb_samples);
 ...
 */
char* lastErrorStr_MBR(char *buffer, int bufsize);

/*
 * Tolerance to missing diphones.
 */
void setNoError_MBR(int no_error);
